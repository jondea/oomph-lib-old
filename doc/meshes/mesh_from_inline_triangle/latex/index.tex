...
\hypertarget{index_overview}{}\section{Overview of mesh generation procedures}\label{index_overview}
...
\{ 
 ...
 sprintf(filename,\textcolor{stringliteral}{"RESLT/soln%i.dat"},Doc\_info.number());
 ...
 \textcolor{comment}{//----------------------}
 sprintf(filename,\textcolor{stringliteral}{"RESLT/exact\_soln%i.dat"},Doc\_info.number());
 some\_file.open(filename);
 ...
 \textcolor{comment}{//------------------}
 sprintf(filename,\textcolor{stringliteral}{"RESLT/boundaries%i.dat"},Doc\_info.number());
 some\_file.open(filename);
 ...
 sprintf(filename,\textcolor{stringliteral}{"RESLT/error%i.dat"},Doc\_info.number());
 some\_file.open(filename);
...
\begin{center} \href{../../../../src/generic/projection.h}{\tt src/generic/projection.\+h } \end{center} 
...
\hypertarget{index_how_many_segments}{}\subsection{How many vertices should I use to sample my curvilinear boundary?}\label{index_how_many_segments}
