...
Connections to {\ttfamily Triangle\+Mesh\+Poly\+Line} can only be made by using existing vertices of the destination {\ttfamily Triangle\+Mesh\+Poly\+Line}. Conversely, connections to {\ttfamily Triangle\+Mesh\+Curvi\+Line} can be made by specifying the position along the {\ttfamily Triangle\+Mesh\+Curvi\+Line}. The connection point is identified by the {\ttfamily Triangle\+Mesh\+Curvi\+Line\textquotesingle{}s} intrinsic coordinates. The figure below shows the case when a connection with a {\ttfamily Triangle\+Mesh\+Poly\+Line} is possible.
