...
\textcolor{comment}{}\textcolor{comment}{//========================================================================}
\textcolor{keyword}{template}<\textcolor{keyword}{class} ELEMENT, \textcolor{keywordtype}{unsigned} DIM, \textcolor{keywordtype}{unsigned} NNODE\_1D>
\textcolor{keywordtype}{void} \hyperlink{classMyBiharmonicBellProblem_ae361099fb498e9965ea37a648ce71032}{MyBiharmonicBellProblem<ELEMENT,DIM,NNODE\_1D>::doc\_solution}
      (DocInfo& doc\_info)
\{ 
 ...
 sprintf(filename,\textcolor{stringliteral}{"%s/exact\_soln%i.dat"},doc\_info.directory().c\_str(),
         doc\_info.number());some\_file.open(filename);
 some\_file.open(filename);
 mesh\_pt()->output\_fct(some\_file,npts,\hyperlink{namespacePhysical__Variables_af90d0c580c57b1152fd1cc7046055031}{Physical\_Variables::get\_exact\_u}); 
 some\_file.close();
 ...
 sprintf(filename,\textcolor{stringliteral}{"%s/error%i.dat"},doc\_info.directory().c\_str(),
         doc\_info.number());
 some\_file.open(filename);
 mesh\_pt()->compute\_error(some\_file,\hyperlink{namespacePhysical__Variables_af90d0c580c57b1152fd1cc7046055031}{Physical\_Variables::get\_exact\_u},
                          error,norm); 
 some\_file.close();
