...
\doxyfigcaption{Radiated power as function of the F\+SI parameter Q for an axisymmetrically oscillating coating. Markers\+: computed results; continuous line\+: analytical result. }
\end{DoxyImage}
...
Next we create the mesh that will store the {\ttfamily Face\+Elements} that will apply the Sommerfeld radiation condition, using the specified number of Fourier terms in the Dirichlet-\/to-\/\+Neumann mapping; see the \href{../../../helmholtz/scattering/html/index.html#DtN}{\tt Helmholtz tutorial} for details.
...
\{
 ...
 \textcolor{comment}{// Output exact solution for Helmholtz }
 \textcolor{comment}{//------------------------------------}
 sprintf(filename,\textcolor{stringliteral}{"%s/exact\_helmholtz\_soln%i.dat"},Doc\_info.directory().c\_str(),
         Doc\_info.number());
 some\_file.open(filename);
 Helmholtz\_mesh\_pt->output\_fct(some\_file,n\_plot,
                                 \hyperlink{namespaceGlobal__Parameters_af95baf4096a1393ab06bfa9ff9a57a35}{Global\_Parameters::exact\_axisym\_potential}
      ); 
 some\_file.close();
...
\begin{DoxyItemize}
\item Heil, M., Kharrat, T., Cotterill, P.\+A. \& Abrahams, I.\+D. (2012) Quasi-\/resonances in sound-\/insulating coatings. {\itshape Journal of Sound and Vibration} {\bfseries 331} 4774-\/4784. D\+OI\+: \href{http://dx.doi.org/10.1016/j.jsv.2012.05.029}{\tt 10.\+1016/j.sv.\+2012.\+05.\+029}
\end{DoxyItemize}
\end{DoxyItemize}
