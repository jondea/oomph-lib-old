...
\hypertarget{index_theory}{}\section{The expected deformation and the displacement-\/control formulation of the problem}\label{index_theory}
...
\textcolor{comment}{}\textcolor{comment}{//========================================================================}
\textcolor{keyword}{template}<\textcolor{keyword}{class} ELEMENT>
\textcolor{keywordtype}{void} \hyperlink{classElasticRingProblem_ab644c5fd57310f2d4c858f64d8c5a223}{ElasticRingProblem<ELEMENT>::doc\_solution}(DocInfo& doc\_info,
...
\{ 
 ...
 \textcolor{comment}{// Local coordinates of plot points at left and right end of domain}
 Vector<double> s\_left(1);
 s\_left[0]=-1.0;
 Vector<double> s\_right(1);
 s\_right[0]=1.0;

 \textcolor{comment}{// Write trace file: Pressure, two radii}
 trace\_file 
  << \hyperlink{namespaceGlobal__Physical__Variables_a9d598320fb3d7ecf94101088e8f376d2}{Global\_Physical\_Variables::Pext\_data\_pt}->value(0)/
  (pow(\hyperlink{namespaceGlobal__Physical__Variables_af6e07423e22c0991084d9a2f43727805}{Global\_Physical\_Variables::H},3)/12.0)  
  << \textcolor{stringliteral}{" "} 
  << \textcolor{keyword}{dynamic\_cast<}ELEMENT*\textcolor{keyword}{>}(mesh\_pt()->
                            element\_pt(0))->interpolated\_x(s\_left,0)
  << \textcolor{stringliteral}{" "} 
  << \textcolor{keyword}{dynamic\_cast<}ELEMENT*\textcolor{keyword}{>}
  (mesh\_pt()->element\_pt(Nbeam\_element-1))->interpolated\_x(s\_right,1)
  << std::endl;
...
\begin{DoxyCodeInclude}
\textcolor{comment}{//========start\_of\_run=====================================================}
\textcolor{comment}{/// Solver loop to perform parameter study}
\textcolor{comment}{}\textcolor{comment}{//=========================================================================}
\textcolor{keyword}{template}<\textcolor{keyword}{class} ELEMENT>
\textcolor{keywordtype}{void} \hyperlink{classElasticRingProblem_afed9c0948c535c315c3e22e92e3266d3}{ElasticRingProblem<ELEMENT>::parameter\_study}(DocInfo& 
      doc\_info)
\{
 ...
 ofstream trace\_file(filename);
 trace\_file << \textcolor{stringliteral}{"VARIABLES=\(\backslash\)"p\_e\_x\_t\(\backslash\)",\(\backslash\)"R\_1\(\backslash\)",\(\backslash\)"R\_2\(\backslash\)""} << std::endl;
...
\hypertarget{index_further}{}\section{Further comments and Exercises}\label{index_further}
