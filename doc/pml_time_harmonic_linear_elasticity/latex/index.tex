...
\hline
\begin{center} {\bfseries Acknowledgement\+:} The implementation of the equations and the documentation were developed jointly with \href{http://imperial.academia.edu/RaduCimpeanu}{\tt Radu Cimpeanu} (Imperial College London), with financial support from Thales Underwater. \end{center}    \\\cline{1-1}
\end{longtabu}
\end{center} 
...
\hypertarget{index_impl}{}\subsection{Implementation of the perfectly matched layers within oomph-\/lib}\label{index_impl}
...
\textcolor{comment}{} \textcolor{keywordtype}{unsigned} N\_y\_bottom\_pml = 8; 
 ...
 \textcolor{comment}{// Outer physical length of the PML layers}
 \textcolor{comment}{// defaults to 0.2, so 10% of the size of the }
 \textcolor{comment}{// physical domain}
 \textcolor{keywordtype}{double} Width\_x\_right\_pml  = 2.0;
 \textcolor{keywordtype}{double} Width\_y\_top\_pml    = 2.0;
 \textcolor{keywordtype}{double} Width\_x\_left\_pml   = 2.0;
 \textcolor{keywordtype}{double} Width\_y\_bottom\_pml = 2.0;
\textcolor{comment}{}
\textcolor{comment}{ /// Function to compute dependent parameters}
\textcolor{comment}{} \textcolor{keywordtype}{void} \hyperlink{namespaceGlobal__Parameters_aafb6ae2e2642a42a7c8ce999837d18b1}{compute\_dependent\_parameters}()
 \{\textcolor{comment}{}
\textcolor{comment}{  /// Adjust number of PML elements, set to be equal for all layers}
\textcolor{comment}{}  N\_x\_right\_pml  = N\_x\_right\_pml  * \hyperlink{namespaceGlobal__Parameters_a9af8f57814ac363b52f2a88d75864524}{N\_pml\_multiplier};
  N\_x\_left\_pml   = N\_x\_left\_pml   * \hyperlink{namespaceGlobal__Parameters_a9af8f57814ac363b52f2a88d75864524}{N\_pml\_multiplier};
  N\_y\_top\_pml    = N\_y\_top\_pml    * \hyperlink{namespaceGlobal__Parameters_a9af8f57814ac363b52f2a88d75864524}{N\_pml\_multiplier};
  N\_y\_bottom\_pml = N\_y\_bottom\_pml * \hyperlink{namespaceGlobal__Parameters_a9af8f57814ac363b52f2a88d75864524}{N\_pml\_multiplier};
\textcolor{comment}{}
\textcolor{comment}{  ///Adjust physical size of PML layers, set to be equal for all layers}
\textcolor{comment}{}  Width\_x\_right\_pml  = Width\_x\_right\_pml  * \hyperlink{namespaceGlobal__Parameters_a7a49a7bc4052082ccf10caf8ff7a52b6}{L\_pml\_multiplier};
  Width\_x\_left\_pml   = Width\_x\_left\_pml   * \hyperlink{namespaceGlobal__Parameters_a7a49a7bc4052082ccf10caf8ff7a52b6}{L\_pml\_multiplier};
  Width\_y\_top\_pml    = Width\_y\_top\_pml    * \hyperlink{namespaceGlobal__Parameters_a7a49a7bc4052082ccf10caf8ff7a52b6}{L\_pml\_multiplier};
  Width\_y\_bottom\_pml = Width\_y\_bottom\_pml * \hyperlink{namespaceGlobal__Parameters_a7a49a7bc4052082ccf10caf8ff7a52b6}{L\_pml\_multiplier};
 \}
\textcolor{comment}{}
...
\textcolor{comment}{} \textcolor{keywordtype}{double} Omega\_sq=30.0; 
  \textcolor{comment}{}
\textcolor{comment}{ /// The elasticity tensor}
\textcolor{comment}{} PMLTimeHarmonicIsotropicElasticityTensor* \hyperlink{namespaceGlobal__Parameters_a9dc0631434879b47501f64851ad679b8}{E\_pt};
 \textcolor{comment}{}
...
\begin{DoxyCodeInclude}
 ...
 \textcolor{comment}{//--------------------------}
 sprintf(filename,\textcolor{stringliteral}{"%s/soln\_bulk%i.dat"},Doc\_info.directory().c\_str(),
         Doc\_info.number());
...
\begin{DoxyCodeInclude}
 \textcolor{comment}{// Output runtime (wall clock time) in s in a file}
 sprintf(filename,\textcolor{stringliteral}{"%s/wall\_clock\_time%i.dat"},Doc\_info.directory().c\_str(),
         Doc\_info.number()); 
 some\_file.open(filename);
 some\_file << \hyperlink{namespaceGlobal__Parameters_a42ef00f24f3bc5c16dae72557c736634}{Global\_Parameters::T\_end}-
      \hyperlink{namespaceGlobal__Parameters_a6106a50c4a420f4040e2ccd7d443267c}{Global\_Parameters::T\_start} << std::endl;
 some\_file.close();

 \textcolor{comment}{// Output number of degrees of freedom in a file}
 sprintf(filename,\textcolor{stringliteral}{"%s/ndof%i.dat"},Doc\_info.directory().c\_str(),
         Doc\_info.number()); 
 some\_file.open(filename);
 some\_file << this->ndof() << std::endl;
 some\_file.close();
 ...
 sprintf(filename,\textcolor{stringliteral}{"%s/elast\_soln\_norm%i.dat"},Doc\_info.directory().c\_str(),
         Doc\_info.number());   
 some\_file.open(filename);   
 \textcolor{keywordtype}{double} norm\_soln=0.0;
 this->mesh\_pt()->compute\_norm(norm\_soln);  
 some\_file << sqrt(norm\_soln) << std::endl;
 cout << \textcolor{stringliteral}{"Norm of computed solution: "}   << sqrt(norm\_soln)  << endl;
