...
We suppress the listing of the remaining combinations (see the driver code \href{../../../../demo_drivers/solid/compressed_square/compressed_square.cc}{\tt compressed\+\_\+square.\+cc }for details)\+:
\begin{DoxyItemize}
...
\textcolor{comment}{}\textcolor{comment}{//==================================================================}
\textcolor{keyword}{template}<\textcolor{keyword}{class} ELEMENT>
\textcolor{keywordtype}{void} \hyperlink{classCompressedSquareProblem_a34d511f377379122d65b2a1402898f5c}{CompressedSquareProblem<ELEMENT>::doc\_solution}(\textcolor{keyword}{const} \textcolor{keywordtype}{
      bool}& incompress)
\{
 ofstream some\_file;
 ...
 Trace\_file << \hyperlink{namespaceGlobal__Physical__Variables_a8b80d3e8d63b8d0a0ed435a2dd7fe2ad}{Global\_Physical\_Variables::Gravity}  << \textcolor{stringliteral}{" "} 
     ...
     \textcolor{keywordflow}{for}(\textcolor{keywordtype}{unsigned} l1=0;l1<n\_plot;l1++)
      \{
       ...
       \textcolor{comment}{// Get Lagrangian coordinates}
         ...
         \textcolor{comment}{// Stresses}
         sigma(0,0)=nu/(1.0-nu)*\hyperlink{namespaceGlobal__Physical__Variables_a8b80d3e8d63b8d0a0ed435a2dd7fe2ad}{Global\_Physical\_Variables::Gravity}*(x[1]-
      1.0);
         sigma(1,0)=0.0;
         sigma(1,1)=\hyperlink{namespaceGlobal__Physical__Variables_a8b80d3e8d63b8d0a0ed435a2dd7fe2ad}{Global\_Physical\_Variables::Gravity}*(x[1]-1.0);
          
         \textcolor{comment}{// Output linear stress tensor}
