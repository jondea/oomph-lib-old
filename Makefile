...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	$(top_srcdir)/config/makefile_templates/doc
...
AUTOMAKE = ${SHELL} /home/runner/work/oomph-lib/oomph-lib/missing automake-1.15
AWK = gawk
BLACS_LIB = 
BLAS_LIB = 
...
abs_builddir = /home/runner/work/oomph-lib/oomph-lib/doc
abs_srcdir = /home/runner/work/oomph-lib/oomph-lib/doc
...
EXTRA_DIST = Doxyfile $(docfile).txt figures \
	oomph-lib_header.html.template oomph-lib_footer.html.template \
	css js extra_latex_style_files navbar_toggle.js raw_doxygen
...
.SUFFIXES:
.SUFFIXES: .txt_doxygenified.h .txt
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(top_srcdir)/config/makefile_templates/doc $(am__configure_deps)
	@for dep in $?; do \
...
$(top_srcdir)/config/makefile_templates/doc $(am__empty):
