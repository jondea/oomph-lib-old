...
\doxyfigcaption{Animation (H\+T\+ML only) of the resulting displacement field. }
\end{DoxyImage}
...
\textcolor{comment}{//===start\_of\_Global\_Parameters\_namespace===============================}
...
\textcolor{comment}{} \textcolor{keywordtype}{double} \hyperlink{namespaceGlobal__Parameters_aa3dfbdb1b2fd80d516850f66c96b6fd0}{E} = 1.0;
\textcolor{comment}{}
\textcolor{comment}{ /// Lame parameters}
\textcolor{comment}{} \textcolor{keywordtype}{double} \hyperlink{namespaceGlobal__Parameters_ae2f84a82174136947cce7a0d137097ae}{Lambda} = E*Nu/(1.0+\hyperlink{namespaceGlobal__Parameters_a20fccdcfa2c15ad8b951b9ada3bb1661}{Nu})/(1.0-2.0*Nu);
 \textcolor{keywordtype}{double} \hyperlink{namespaceGlobal__Parameters_a490d7680a7de63058a9c921e2705a103}{Mu} = E/2.0/(1.0+\hyperlink{namespaceGlobal__Parameters_a20fccdcfa2c15ad8b951b9ada3bb1661}{Nu});
\textcolor{comment}{}
\textcolor{comment}{ /// Square of the frequency of the time dependence}
\textcolor{comment}{} \textcolor{keywordtype}{double} \hyperlink{namespaceGlobal__Parameters_af9e1e178dfb7f5e35b452599bd4c4324}{Omega\_sq} = 0.5;
\textcolor{comment}{}
\textcolor{comment}{ /// Number of elements in r-direction}
\textcolor{comment}{} \textcolor{keywordtype}{unsigned} \hyperlink{namespaceGlobal__Parameters_aeebb1e39d849d32cebdc9be13026606e}{Nr} = 5;
\textcolor{comment}{}
\textcolor{comment}{ /// Number of elements in z-direction}
\textcolor{comment}{} \textcolor{keywordtype}{unsigned} \hyperlink{namespaceGlobal__Parameters_a1f35a0690c7745167a7178fb71f92e6e}{Nz} = 10;
\textcolor{comment}{}
\textcolor{comment}{ /// Length of domain in r direction}
\textcolor{comment}{} \textcolor{keywordtype}{double} \hyperlink{namespaceGlobal__Parameters_a444f5c911c8805ad2ba45ed8b1b8904e}{Lr} = 1.0;
\textcolor{comment}{}
\textcolor{comment}{ /// Length of domain in z-direction}
\textcolor{comment}{} \textcolor{keywordtype}{double} \hyperlink{namespaceGlobal__Parameters_a2bcf0bd846d839f1e3bb04a6c0a612c1}{Lz} = 2.0;
\textcolor{comment}{}
\textcolor{comment}{ /// Set up min r coordinate}
\textcolor{comment}{} \textcolor{keywordtype}{double} \hyperlink{namespaceGlobal__Parameters_ab0e73c8b2e1105b14203856b81efa8cf}{Rmin} = 0.1;
\textcolor{comment}{}
...
\textcolor{comment}{}\textcolor{comment}{//========================================================================}
\textcolor{keyword}{template}<\textcolor{keyword}{class} ELEMENT, \textcolor{keyword}{class} TIMESTEPPER>
\textcolor{keywordtype}{void} \hyperlink{classAxisymmetricLinearElasticityProblem_a370b76b9e2902242de018339d3aedd04}{AxisymmetricLinearElasticityProblem<ELEMENT, TIMESTEPPER>::}
\hyperlink{classAxisymmetricLinearElasticityProblem_a370b76b9e2902242de018339d3aedd04}{doc\_solution}(DocInfo& doc\_info)
\{ 
 ofstream some\_file;
 \textcolor{keywordtype}{char} filename[100];
 
 \textcolor{comment}{// Number of plot points}
 \textcolor{keywordtype}{unsigned} npts=10; 
 ...
 sprintf(filename,\textcolor{stringliteral}{"%s/exact\_soln%i.dat"},doc\_info.directory().c\_str(),
   doc\_info.number());
 some\_file.open(filename);
 Bulk\_mesh\_pt->output\_fct(some\_file,npts,time\_pt()->time(),
                          \hyperlink{namespaceGlobal__Parameters_a7da914d64b7a62d35793172f6a0fd712}{Global\_Parameters::exact\_solution});
 some\_file.close();
