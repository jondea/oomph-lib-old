...
\image html PMLDomain.gif "Sketch illustrating the geometry of the perfectly matched layers. " 
\image latex PMLDomain.eps "Sketch illustrating the geometry of the perfectly matched layers. " width=0.75\textwidth
...
\image html mesh.gif "Mesh used to resolve the geometry. " 
\image latex mesh.eps "Mesh used to resolve the geometry. " width=0.6\textwidth
...
\image html result1.gif "Real part of the horizontal displacement. Exact and computed solution carpet plot (left) and (-2.0,0.0) to (2.0,0.0) one-dimensional slice (right). Green: exact; dark blue: computed; light blue: perfectly matched layers. " 
\image latex result1.eps "Real part of the horizontal displacement. Exact and computed solution carpet plot (left) and (-2.0,0.0) to (2.0,0.0) one-dimensional slice (right). Green: exact; dark blue: computed; light blue: perfectly matched layers. " width=0.95\textwidth

\image html result2.gif "Imaginary part of the horizontal displacement. Exact and computed solution carpet plot (left) and (-2.0,0.0) to (2.0,0.0) one-dimensional slice (right). Green: exact; dark blue: computed; light blue: perfectly matched layers. " 
\image latex result2.eps "Imaginary part of the horizontal displacement. Exact and computed solution carpet plot (left) and (-2.0,0.0) to (2.0,0.0) one-dimensional slice (right). Green: exact; dark blue: computed; light blue: perfectly matched layers. " width=0.95\textwidth
...
\image html result3.gif "Real part of the computed radial displacement. " 
\image latex result3.eps "Real part of the computed radial displacement. " width=0.6\textwidth

\image html result4.gif "Imaginary part of the computed radial displacement. " 
\image latex result4.eps "Imaginary part of the computed radial displacement. " width=0.6\textwidth
